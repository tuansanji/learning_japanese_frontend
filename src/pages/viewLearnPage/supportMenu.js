...
export default function ScrollableTabsButtonPrevent() {
  ...
  return (
    <div className={classes.root}>
      ...
      <TabPanel className="w-20%" value={value} index={0}>
        Item One
      </TabPanel>
      <TabPanel className="w-20%" value={value} index={1}>
        Item Two
      </TabPanel>
      <TabPanel className="w-20%" value={value} index={2}>
        Item Three
      </TabPanel>
      <TabPanel className="w-20%" value={value} index={3}>
        Item Four
      </TabPanel>
      <TabPanel className="w-20%" value={value} index={4}>
        Item Five
      </TabPanel>
    </div>
  );
