...
function NotFoundPage() {
  ...
  return (
    <div style={{ padding: "20px" }}>
      ...
      <div className="w-full flex justify-center text-[4rem] md:text-[2.5rem] sm:text-[2rem] font-bold gap-5 mt-5">
        <p>PAGE NOT FOUND</p>
        <Link className="text-blue-500 hover:text-green-500" to="/">
          HOME
        </Link>
      </div>
    </div>
